            ...
            <div class="col-sm-7">
                <div class="header-caption">
                    ...
                    <div class="header-action-button">
                        <form action="PublicData" method="post">
                        <button type="submit" class="btn btn-default btn-bordered  btn-md" href="#">Check In</button>
                        <button type="submit" class="btn btn-default btn-bordered  btn-md" href="#">Check out</button>
                        </form>
