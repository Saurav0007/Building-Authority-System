        ...
        <div class="row">
            <div class="col-sm-10">
                <div class="header-caption">
                    <h2 class="Header-caption">Your Report Feedback</h2>
                    ...
                    <form action="#" class="row" method="post">
                        ...
                        <table id="editdatatable" class="table table-bordered table-responsive">
                            ...
                            @foreach($PD as $pd)
                                <tr>
                                    <td>{{$p=$p+1}}</td>
                                    <td class="text-center">{{$pd["publicName"]}}</td>
                                    <td class="text-center">{{$pd["publicEmail"]}}</td>
                                    <td class="text-center">{{$pd["publicReportType"]}}</td>
                                    <td class="text-center">{{$pd["publicReportMsg"]}}</td>
                                    @foreach($FD as $fd)
                                        <td class="text-center">{{$fd["publicFeedbackReport"]}} </td>
                                    @endforeach
                                </tr>
                            @endforeach
                            </tbody>
