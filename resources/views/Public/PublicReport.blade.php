                        ...
                        <nav id="site-navigation" class="main-navigation" role="navigation">
                            ...
                            <div class="menu-testing-menu-container">
                                <ul id="primary-menu" class="menu nav-menu" aria-expanded="false">
                                    ...
                                    <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#">Presence</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="PublicPresence">Check In</a></li>
                                            <li class="menu-item"><a href="PublicPresence">Check Out</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#">Select Destination</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="Publicshop">Shop</a></li>
                                            <li class="menu-item"><a href="Publicoffice">Office</a></li>
                                        </ul>
                                    </li>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="header-caption">
                    ...
                    <form action="/SubmitPublicReport" method="post">
                        @csrf
                        <div class="form-group col-md-8">
                            <input type="text" name="Pname" class="form-control" required="required" placeholder="Name">
                        </div>
                        <div class="form-group col-md-8">
                            <input type="email" name="Pemail" class="form-control" required="required" placeholder="Email">
                        </div>
                        <div class="form-group col-md-8">
                            <input type="text" name="PReportType" class="form-control" required="required" placeholder="Complain type or subject">
                        </div>
                        <div class="form-group col-md-8">
                            <input type="text" name="PReportMsg" required="required" class="form-control" placeholder="Your Report Here">
                        </div>
                        <div class="form-group col-md-8">
    ...
    <div class="container-fluid container-no-padding">
        <div class="row row-no-margin">
            <div class="image-block-item col-md-6 col-sm-5 col-xs-12">
                <div class="image-block-item-background" style="background-image: url('{{asset("assets/img/img-post-content-04.jpg")}}');"></div>
