           ...
           <div class="row">
             ...
             <div class="header-caption">
                    ...
                    <div class="status alert alert-success" style="display: none"></div>
                       <form action="WorkerAccountDetails" class="row"  method="post">
                           @csrf
                           <div class="form-group col-sm-12">
                               <input type="text" name="WorkerName" class="form-control" required="required" placeholder="Name">
                           </div>
                           <div class="form-group col-md-12">
                               <input type="email" name="WorkerEmail" class="form-control" required="required" placeholder="Email">
                           </div>
                           <div class="form-group col-md-12">
                               <input type="text" name="WorkerPhone"class="form-control" placeholder="Phone Number">
                           </div>
                           <div class="form-group col-sm-12">
                               <input type="text" name="WorkerAddress" class="form-control" required="required" placeholder="Address">
                           </div>
                           <div class="form-group col-md-12">
                               <input type="password" name="WorkerPassword" class="form-control" required="required" placeholder="Password">
                           </div>
