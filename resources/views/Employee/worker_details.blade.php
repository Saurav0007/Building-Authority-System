             ...
             <div class="container">
               ...
               <div class="col-sm-10">
                    <div class="header-caption">
                        <h2 class="Header-caption">Worker Account Details</h2><div class="status alert alert-success" style="display: none"></div>
                        <form action="#" class="row"  method="post">
                         ...
                         <table class="table table-bordered table-responsive">
                             ...
                             <tr>
                                 <td>{{$wd['WorkerName']}}</td>
                                 <td>{{$wd['WorkerEmail']}}</td>
                                 <td>{{$wd['WorkerPassword']}}</td>
                                 <td>{{$wd['WorkerPhone']}}</td>
                                 <td>{{$wd['WorkerWPlace']}}</td>
                                 <td>{{$wd['WorkerAddress']}}</td>
