             ...
             <div class="row">
               <div class="col-sm-10">
                <div class="header-caption">
                      <h2 class="Header-caption">All details of shop/offices</h2>
                    ...
                    <form action="#" class="row" >
                      ...
                      <table class="table table-bordered table-responsive-xl">
                          ...
                          <tbody>
                          @foreach($EmpSO as $empso)
                          <tr>
                              <td>{{$empso['ShopName']}}</td>
                              <td>{{$empso['ShopType']}}</td>
                              <td>{{$empso['ShopNo']}}</td>
                              <td>{{$empso['ShopDetails']}}</td>
                             <td><img src="Uploads/SOpicture/{{$empso['ShopPhoto']}}" width="100" height="100" alt="No Image Given"> </td>
