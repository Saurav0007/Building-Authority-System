...
<head>
    ...
    <title>BAS Admin Empty Room Details</title>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="site-branding">
                                <h1 class="site-title title-image"><a href="employee" rel="home"><img
                        ...
                        <div class="col-sm-9">
                            <nav id="site-navigation" class="main-navigation" role="navigation">
                                <button class="menu-toggle" type="button" aria-controls="primary-menu"
                                        aria-expanded="false"><span class="pe-7s-menu"></span><span class="sr-only">Primary Menu</span>
                                </button>

                                <div class="menu-testing-menu-container">
                                    <ul id="primary-menu" class="menu nav-menu" aria-expanded="false">
                                        <li class="menu-item current-menu-item"><a href="employee" style="color:#000000;">Home</a></li>
                                        <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#" style="color:#000000">Create
                                                Account</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children"><a href="worker_details" style="color:#40fbab">Worker</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="worker_regi" style="color:#40fbab">Registration</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children" aria-haspopup="true"><a
                                                        href="public_details" style="color:#40fbab">Public</a>
                                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children" aria-haspopup="true"><a
                                                href="permission_list" style="color:#000000">Permissions</a>
                                            <ul class="sub-menu">
                                                <li class="sub-menu" aria-haspopup="true"><a href="permission_details" style="color:#40fbab">Permission
                                                        Details</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children" aria-haspopup="true"><a
                                                href="EmployeeRoomDetails" style="color:#000000">Room Details</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item" aria-haspopup="true"><a href="EmptyRoomDetails" style="color:#40fbab">Empty
                                                        Rooms</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item"><a href="shop_office" style="color:#000000">Shop/Office
                                                Details</a></li>
            ...
            <div class="row">
                <div class="col-sm-10">
                    <div class="header-caption">
                        <h2 class="Header-caption">Empty Room Details</h2>
                        <div class="status alert alert-success" style="display: none"></div>
                        <form action="#" class="row" method="">
                            @csrf
                            <table id="editdatatable" class="table table-bordered table-responsive">
                                <thead>
                                <tr>
                                ...
                                @foreach($ERD as $erd)
                                    <tr>
                                        <td>{{$erd['name']}}</td>
                                        <td>{{$erd['RoomNo']}}</td>
                                        <td>{{$erd['RoomDetails']}}</td>
                                        <td>{{$erd['check']}}</td>
                                        <td><a href="/EmpRoomDetailsdelete/{{$erd['id']}}" onclick="javascript:return confirm('Are you sure you want to delete this room details?')"><i class="btn btn-danger">Delete</i></a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
