                ...
                <div class="row">
                  <div class="col-sm-10">
                    <div class="header-caption">
                        <h2 class="Header-caption">Account Creation for Public</h2>
                        <div class="status alert alert-success" style="display: none"></div>
                        <form action="PublicAccountDetails" class="row"  method="post">
                            @csrf
                          <div class="form-group col-sm-12">
                            <input type="text" name="PublicName" class="form-control" required="required" placeholder="Name">
                          </div>
                          <div class="form-group col-md-12">
                            <input type="email" name="PublicEmail" class="form-control" required="required" placeholder="Email">
                          </div>
                            <div class="form-group col-md-12">
                                <input type="text" name="PublicPhone"class="form-control" placeholder="Phone Number">
                            </div>
                            <div class="form-group col-sm-12">
                                <input type="text" name="PublicAddress" class="form-control" required="required" placeholder="Address">
                            </div>
                          <div class="form-group col-md-12">
                            <input type="password" name="PublicPassword" class="form-control" required="required" placeholder="Password">
                          </div>
