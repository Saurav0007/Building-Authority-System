                    ...
                    <div class="row">
                        <div class="col-sm-10">
                                <form action="#" class="row"  method="post">
                                    @csrf
                                    <div class="name"><h2>Public Checked Out users</h2></div>
                                    <table class="table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                        @foreach($pubCheckOut as $pco)
                                            <tr>
                                                <td>{{$pco['CheckOutId']}}</td>
                                                <td>{{$pco['CheckOutEmail']}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>

                                    <div class="name"><h2>Worker Checked Out user</h2></div>
                                    <table class="table table-bordered table-responsive">
                                        <thead>
                                        <tr>
                                            <th>ID</th>
                                        ...
                                        <tbody>
                                        @foreach($worCheckOut as $wco)
                                            <tr>
                                                <td>{{$wco['workerCheckOutId']}}</td>
                                                <td>{{$wco['workerCheckOutEmail']}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
